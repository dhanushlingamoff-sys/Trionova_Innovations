            ...
            <div class="tn-hero-center">
                <div class="tn-stage">
                    ...
                    <div class="tn-phone" id="tnPhoneScreen">
                        ...
                        <img class="tn-phone-img" src="{{ asset('images/mobile-app-ad/mobile-4.webp') }}" alt="Mobile app screen" loading="lazy">
                        <img class="tn-phone-img" src="{{ asset('images/mobile-app-ad/mobile-7.webp') }}" alt="Mobile app screen" loading="lazy">
                        <img class="tn-phone-img" src="{{ asset('images/mobile-app-ad/mobile-10.webp') }}" alt="Mobile app screen" loading="lazy">
                    </div>
                </div>
            </div>
...
(function () {
    ...
    /* ---- Phone: rotate device mockups every 4s ---- */
    var screens = document.querySelectorAll('#tnPhoneScreen .tn-phone-img');
