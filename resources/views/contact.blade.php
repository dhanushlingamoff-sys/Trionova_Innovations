...
<script>
  ...
  gtag('config', 'G-244KHB99SM');
        ...
        <!--<title>Top Software Development & IT Consulting in Toronto | Trionova Technology</title> -->
        <meta charset="utf-8">
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
        <meta name="author" content="ThemeZaa">
        <meta name="viewport" content="width=device-width,initial-scale=1.0" />
        <meta name="description" content="Trionova Technology offers web application development, enterprise software, data analytics, AI, cloud-native deployment services from Toronto. Partner with us for innovative solutions.">
        <!--<link rel="canonical" href="https://www.trionova.in"/>-->
        <meta property="og:title" content="Trionova Technology | Top Technology Consulting Company for Innovative Business Solutions" />
        <meta property="og:description" content="Trionova Technology empowers businesses with AI, Mobile App Development, Cloud Services, Data Science, Web Development and product engineering solutions." />
        ...
        <script src="https://www.google.com/recaptcha/api.js?render=6LfsNNsqAAAAAIuXjo20djX0JbBbxqrG1wHS7UEf"></script>
            ...
            <div class="container">
                <div class="row justify-content-center align-items-center" data-anime='{ "el": "childs", "opacity": [0,1], "duration": 600, "delay": 0, "staggervalue": 300, "easing": "easeOutQuad" }'> 
                    <div class="col-lg-6 pt-8 pb-8 text-center text-sm-start"> 
                        <h6 class="alt-font fw-700 text-dark-gray mb-15px">Coimbatore</h6>
                        <div class="row row-cols-1 row-cols-sm-2 mb-10">
                            <div class="col last-paragraph-no-margin xs-mb-20px">
                            
                                <p class="w-80 lg-w-100">Dicotix Dry Mostaas Compang
                                    10. 2/6C, VIRS Nagas,
                                    Cheranma Nagas,
                                    57h Bus Stop.
                                    Vilankurichi, coimbatare</p>
                            </div>
                            <div class="col">
                                <span class="fs-18 alt-font fw-600 d-block text-dark-gray mb-5px">Get in touch</span>
                                <a href="tel:+919442132694">+91 9442132694</a><br>
                                <a href="mailto:Info@trionova.in" class="text-decoration-line-bottom text-dark-gray">Info@trionova.in</a>
                            </div>
                        </div>
                        <h6 class="alt-font fw-700 text-dark-gray mb-15px">Canada </h6>
                        <div class="row row-cols-1 row-cols-sm-2 mb-10">
                            <div class="col last-paragraph-no-margin xs-mb-20px">
                       
                                <p class="w-80 lg-w-100">829 birchmount Rd,
                                    Scarborough 
                                    Ontario 
                                    Canada 
                                    M1K1R9.</p>
                            ...
                            <div class="col">
                                <span class="fs-18 alt-font fw-600 d-block text-dark-gray mb-5px"> Get in touch</span>
                                <a href="tel:+16473265103">+1 647-326-5103</a><br>
                                <a href="mailto:Info@trionova.in" class="text-decoration-line-bottom text-dark-gray">Info@trionova.in</a>
                            </div>
                        </div>
                        <h6 class="alt-font fw-700 text-dark-gray mb-15px">Chennai </h6>
                        <div class="row row-cols-1 row-cols-sm-2">
                            <div class="col last-paragraph-no-margin xs-mb-20px">
                       
                                <p class="w-80 lg-w-100">
                                    <!-- No #254/3, Sree Narayana Complex, C Block, Spic Nagar, Sarathy Nagar, Velachery, Chennai, Tamil Nadu 600042. -->
                        ...
                        <!--<h6 class="alt-font fw-700 text-dark-gray mb-15px mt-4">Bangalore  </h6>-->
                        <!--<div class="row row-cols-1 row-cols-sm-2">-->
                        <!--    <div class="col last-paragraph-no-margin xs-mb-20px">-->
                       
                        <!--        <p class="w-80 lg-w-100">A901, dnr casablanca, maheshwari nagar, mahadevapura, bangalore 560048.</p>-->
                        <!--    </div>-->
                        <!--    <div class="col">-->
                        <!--        <span class="fs-18 alt-font fw-600 d-block text-dark-gray mb-5px"> Get in touch</span>-->
                        <!--        <a href="tel:+919442132694">+91 9442132694</a><br>-->
                    ...
                    <div class="col-lg-6 align-self-start contact-form-style-03 position-relative"> 
                        <div class="contact-form-style-03 position-relative border-radius-10px bg-white p-14 lg-p-10 box-shadow-double-large overflow-hidden last-paragraph-no-margin mt-3" style="">
                    
                            <!--<form action="email-templates/contact-form.php" method="post">-->
                            <!--    <div class="position-relative form-group mb-20px">-->
                            <!--        <span class="form-icon text-dark-gray"><i class="bi bi-person icon-extra-medium"></i></span>-->
                            <!--        <input class="ps-0 border-radius-0px medium-gray bg-transparent border-color-extra-medium-gray form-control required" type="text" name="name" placeholder="Enter your name*">-->
                            <!--    </div>-->
                            <!--    <div class="position-relative form-group mb-20px">-->
                            <!--        <span class="form-icon text-dark-gray"><i class="bi bi-envelope icon-extra-medium"></i></span>-->
                            <!--        <input class="ps-0 border-radius-0px medium-gray bg-transparent border-color-extra-medium-gray form-control required" type="email" name="email" placeholder="Enter your email*">-->
                            <!--    </div>-->
                            <!--    <div class="position-relative z-index-1 form-group form-textarea mt-15px mb-0"> -->
                            <!--        <textarea class="ps-0 border-radius-0px medium-gray bg-transparent border-color-extra-medium-gray form-control" name="comment" placeholder="Enter your message" rows="3"></textarea>-->
                           ...
                           <!--         <input class="ps-0 border-radius-0px bg-transparent border-color-extra-medium-gray form-control required" type="tel" name="phone" placeholder="Your phone" />-->
                           <!--     </div>-->
...
<!--</div>-->
                        <!--<form class="form-horizontal" method="POST" action="">-->
                            ...
                            {{-- <script src="https://js-na2.hsforms.net/forms/embed/243292117.js" defer></script>
                            <div class="hs-form-frame" data-region="na2"
                                data-form-id="2be776aa-a75e-429d-bec8-2fba71890dc0" data-portal-id="243292117"></div> --}}
    ...
    <div class="position-relative form-group mb-20px">
        <span class="form-icon text-medium-gray opacity-6"><i class="bi bi-emoji-smile"></i></span>
        <input class="ps-0 border-radius-0px bg-transparent border-color-extra-medium-gray form-control required" type="text" name="name" placeholder="Your name*" required />
    </div>
    <div class="position-relative form-group mb-20px">
        <span class="form-icon medium-gray opacity-6"><i class="bi bi-envelope"></i></span>
        <input class="ps-0 border-radius-0px bg-transparent border-color-extra-medium-gray form-control required" type="email" name="email" placeholder="Your email address*" required />
    </div>
    <div class="position-relative form-group mb-20px">
        <span class="form-icon text-medium-gray opacity-6"><i class="bi bi-telephone"></i></span>
        <input class="ps-0 border-radius-0px bg-transparent border-color-extra-medium-gray form-control required" type="tel" name="phone" placeholder="Your phone" />
...
<script>
    ...
    // });
      ...
      // Modal form submit handler for #fluttermodal
